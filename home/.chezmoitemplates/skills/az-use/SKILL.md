...
name: az-use
description: >-
  Use when running Azure CLI (`az`) on Windows and any flag value may contain multiline text.
  On Windows, always write multiline content to a file and pass it with az's `"@<file>"` convention.
  Never pass multiline text directly as a flag value.
---
